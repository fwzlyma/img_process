...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("img/sys.png"))
        ...
        self.pushButton_4.clicked.connect(mainWindow.select)
        self.pushButton.clicked.connect(mainWindow.gray)
        self.pushButton_5.clicked.connect(mainWindow.blur)
        self.pushButton_6.clicked.connect(mainWindow.canny)
        self.pushButton_7.clicked.connect(mainWindow.dilate)
        self.pushButton_8.clicked.connect(mainWindow.erode)
        self.pushButton_9.clicked.connect(mainWindow.resize)
        self.pushButton_10.clicked.connect(mainWindow.crop)
        self.pushButton_2.clicked.connect(mainWindow.selectCropPath)
        self.pushButton_3.clicked.connect(mainWindow.selectSavePath)
